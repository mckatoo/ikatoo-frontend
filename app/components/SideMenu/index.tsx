    ...
    <>
      ...
      ">
        ...
        <div className="flex flex-row justify-around py-2">
          <div className="w-6">
            {!!linkedin && <a href={`https://linkedin.com/in/${linkedin}`} target="_blank" rel="noreferrer">
          ...
          <div className="w-6">
            {!!youtube && <a href={`https://www.youtube.com/channel/${youtube}`} target="_blank" rel="noreferrer">
