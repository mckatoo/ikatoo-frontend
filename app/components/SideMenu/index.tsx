...
const SideMenu = ({ items }: SideMenuProps) =>
  ...
  ">
    ...
    <div className="text-lg">
      <ul className="list-reset border-y-slate-700 border-y-2 divide-y divide-slate-700 font-semibold">
        {items.map(({ label, to }, index) => (
          <li key={index} className='py-4 px-10 w-full'>
            <a className="" href={`https://ikatoo.com.br/${to}`}>
              <span>{label}</span>
            </a>
          </li>
        ))}
    ...
    <div className="flex flex-row justify-around py-2">
      <div className="w-6">
        <a href="https://linkedin.com/in/mckatoo" target="_blank" rel="noreferrer">
      ...
      <div className="w-6">
        <a href="https://github.com/mckatoo/" target="_blank" rel="noreferrer">
      ...
      <div className="w-6">
        <a href="https://www.youtube.com/channel/UCc1e1mclC9o5OnQU87PcU1g" target="_blank" rel="noreferrer">
