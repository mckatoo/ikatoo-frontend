...
export const TextContainer = ({ title, children }: BodyContainerProps) => (
  <div className="flex flex-col ml-52 mt-4">
    <div className="font-indie_flower text-slate-700 font-bold before:content-['<html>'] after:content-['</html>']">
      <div className="before:content-['<body>'] after:content-['</body>'] ml-4">
        <header className="before:content-['<header>'] after:content-['</header>'] ml-4 mb-4 flex flex-col">
          <span aria-label={title} className="ml-4 text-5xl font-body text-mck_aqua">{title}</span>
        </header>
        <main className="before:content-['<main>'] after:content-['</main>'] ml-4">
